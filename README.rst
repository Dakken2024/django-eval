...
.. image:: https://img.shields.io/badge/django-3.2%7C4.0%7C4.1%7C4.2-green.svg
   :target: https://www.djangoproject.com/
   :alt: Django 3.2+

.. image:: https://img.shields.io/badge/license-MIT-blue.svg
   :target: https://github.com/your-org/django-eval/blob/main/LICENSE
   :alt: MIT License

A Django reusable app providing a **secure, configurable rule engine** powered by `SimpleEval <https://github.com/danthedeckie/simpleeval>`_.
...
- Range: ``{"field": [1, 10]}``
- List (IN): ``{"field": ["a", "b", "c"]}``
- Empty ``when`` (passthrough): ``{"when": {}, "then": {...}}``
